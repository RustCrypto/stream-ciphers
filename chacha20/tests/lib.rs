...
mod chacha20_tests {
    ...
    fn rfc7539_section_2_4_2() {
        ...
        let nonce = Nonce::from(hex!("000000000000004a00000000"));
        let mut cipher = ChaCha20::new(&key, &nonce);

        // Test from the rfc requires that the counter be 1. Must use the consume the first 64
        // bytes of the block since the chacha20 api starts the counter at 0
