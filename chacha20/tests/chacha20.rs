...
#[cfg(test)]
const IETF_IV1: [u8; IV_BYTES] =
    [ 0x01, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00 ];

#[cfg(test)]
const IETF_IVHI: [u8; IV_BYTES] =
    [ 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x01 ];
...
fn chacha20_IETF_KEY0_IV0() {
    let mut cipher = ChaCha20::new(&GenericArray::from(IETF_KEY0),
...
fn chacha20_IETF_KEY1_IV0() {
    let mut cipher = ChaCha20::new(&GenericArray::from(IETF_KEY1),
                                   &GenericArray::from(IETF_IV0));
    let mut buf = [0; 64];
...
#[test]
fn chacha20_LONG() {
    let mut cipher = ChaCha20::new(&GenericArray::from(KEY_LONG),
